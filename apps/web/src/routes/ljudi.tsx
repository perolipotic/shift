...
/**
 * `Ljudi` — a titled placeholder, and nothing more.
 *
 * ADMIN ONLY (UX-DR32): the member list story 1.5 builds here.
 *
 * It renders its own `nav.ljudi` heading and no other element, because the
